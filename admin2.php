                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="datajabatan.php">
                                <i class="far fa-check-square"></i>Data Divisi</a>
                        </li>
                        <li>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="data_absen.php">
                                <i class="fas fa-calendar-alt"></i>Data Presensi</a>
                        </li>
                        <li>
                            <a href="data_keterangan.php">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <h1>SISTEM KEHADIRAN ANGGOTA PAGUYUBAN</h1>
...
<center><img src="img/logokaryawan.png" width="500" class="img img-responsive" height="500"></center><br>
                            <strong class="col-md-12" style="margin-top: 5rem;">Selamat datang admin SIKAP</strong>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © KSE UINSU 2025<a href="https://colorlib.com"></a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
